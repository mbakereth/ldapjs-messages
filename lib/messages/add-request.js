...
const Protocol = require('@mbakereth/ldapjs-protocol')
...
class AddRequest extends LdapMessage {
   ...
   *
   * @type {null | import('@mbakereth/ldapjs-dn').DN}
   */
  #entry
   ...
   * @property {import('@mbakereth/ldapjs-attribute')[]} [attributes=[]] A set of
   ...
   * attributes.
   *
   * @param {import('@mbakereth/ldapjs-attribute')[]} attrs
   *
   ...
   *
   * @param {string | import('@mbakereth/ldapjs-dn').DN} path
   */
  set entry (path) {
    if (path === null) return
   ...
   *
   * @param {import('@mbakereth/ldapjs-attribute')} attr
   *
   ...
   *
   * @returns {import('@mbakereth/ldapjs-attribute')|null}
   *
