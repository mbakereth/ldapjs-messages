...
const Protocol = require('@mbakereth/ldap-protocol')
...
class AddRequest extends LdapMessage {
   ...
   *
   * @type {null | import('@mbakereth/ldap-dn').DN}
   */
  #entry
   ...
   * @property {import('@mbakereth/ldap-attribute')[]} [attributes=[]] A set of
   ...
   * attributes.
   *
   * @param {import('@mbakereth/ldap-attribute')[]} attrs
   *
   ...
   *
   * @param {string | import('@mbakereth/ldap-dn').DN} path
   */
  set entry (path) {
    if (path === null) return
   ...
   *
   * @param {import('@mbakereth/ldap-attribute')} attr
   *
   ...
   *
   * @returns {import('@mbakereth/ldap-attribute')|null}
   *
