...
const { operations, search } = require('@mbakereth/ldap-protocol')
const { DN } = require('@mbakereth/ldap-dn')
const filter = require('@mbakereth/ldap-filter')
 ...
 * object in the `@mbakereth/ldap-protocol` package. The same constants are exported
...
class SearchRequest extends LdapMessage {
   ...
   * @property {string | import('@mbakereth/ldap-dn').DN} baseObject The path to the
   ...
   * @property {string | import('@mbakereth/ldap-filter').FilterString} filter The
   ...
   *
   * @type {import('@mbakereth/ldap-dn').DN}
   */
  get _dn () {
   ...
   * instances of `@mbakereth/ldap-attribute`.
   *
   * See:
   ...
   *
   * @returns {import('@mbakereth/ldap-dn').DN}
   */
  get baseObject () {
    return this.#baseObject
  }
   ...
   *
   * @param {string | import('@mbakereth/ldap-dn').DN} obj
   */
  set baseObject (obj) {
   ...
   *
   * @returns {import('@mbakereth/ldap-filter').FilterString}
   */
  get filter () {
    return this.#filter
  }
   ...
   *
   * @param {string | import('@mbakereth/ldap-filter').FilterString} value
   */
  set filter (value) {
    if (
      typeof value !== 'string' &&
   ...
   * Internal use only.
   *
   * @param {import('@mbakereth/ldap-asn1').BerWriter} ber
   *
   * @returns {import('@mbakereth/ldap-asn1').BerWriter}
   */
  _toBer (ber) {
