...
const { operations, search } = require('@mbakereth/ldapjs-protocol')
const { DN } = require('@mbakereth/ldapjs-dn')
const filter = require('@mbakereth/ldapjs-filter')
 ...
 * object in the `@mbakereth/ldapjs-protocol` package. The same constants are exported
...
class SearchRequest extends LdapMessage {
   ...
   * @property {string | import('@mbakereth/ldapjs-dn').DN} baseObject The path to the
   ...
   * @property {string | import('@mbakereth/ldapjs-filter').FilterString} filter The
   ...
   *
   * @type {import('@mbakereth/ldapjs-dn').DN}
   */
  get _dn () {
   ...
   * instances of `@mbakereth/ldapjs-attribute`.
   *
   * See:
   ...
   *
   * @returns {import('@mbakereth/ldapjs-dn').DN}
   */
  get baseObject () {
    return this.#baseObject
  }
   ...
   *
   * @param {string | import('@mbakereth/ldapjs-dn').DN} obj
   */
  set baseObject (obj) {
   ...
   *
   * @returns {import('@mbakereth/ldapjs-filter').FilterString}
   */
  get filter () {
    return this.#filter
  }
   ...
   *
   * @param {string | import('@mbakereth/ldapjs-filter').FilterString} value
   */
  set filter (value) {
    if (
      typeof value !== 'string' &&
   ...
   * Internal use only.
   *
   * @param {import('@mbakereth/ldapjs-asn1').BerWriter} ber
   *
   * @returns {import('@mbakereth/ldapjs-asn1').BerWriter}
   */
  _toBer (ber) {
