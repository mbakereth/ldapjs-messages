...
const { operations } = require('@mbakereth/ldap-protocol')
...
class SearchResultEntry extends LdapMessage {
   ...
   *
   * @type {import('@mbakereth/ldap-attribute')[]}
   */
  #attributes = []

  /**
   * @typedef {LdapMessageOptions} SearchResultEntryOptions
   * @property {string | import('@mbakereth/ldap-dn').DN} [objectName=''] The path to
   * the LDAP object.
   * @property {import('@mbakereth/ldap-attribute')[]} attributes A set of attributes
   ...
   * attributes.
   *
   * @param {object[] | import('@mbakereth/ldap-attribute')[]} attrs
   *
   ...
   *
   * @param {string | import('@mbakereth/ldap-dn').DN} value
   *
