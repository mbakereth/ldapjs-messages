...
const { operations } = require('@mbakereth/ldapjs-protocol')
...
class SearchResultEntry extends LdapMessage {
   ...
   *
   * @type {import('@mbakereth/ldapjs-attribute')[]}
   */
  #attributes = []

  /**
   * @typedef {LdapMessageOptions} SearchResultEntryOptions
   * @property {string | import('@mbakereth/ldapjs-dn').DN} [objectName=''] The path to
   * the LDAP object.
   * @property {import('@mbakereth/ldapjs-attribute')[]} attributes A set of attributes
   ...
   *
   * @returns {import('@mbakereth/ldapjs-attribute')[]}
   */
  get attributes () {
   ...
   * attributes.
   *
   * @param {object[] | import('@mbakereth/ldapjs-attribute')[]} attrs
   *
   ...
   *
   * @param {string | import('@mbakereth/ldapjs-dn').DN} value
   *
