 ...
 * const {ModifyRequest} = require('@mbakereth/ldap-messages')
 * const Change = require('@mbakereth/ldap-change')
...
class ModifyRequest extends LdapMessage {
   ...
   * @property {import('@mbakereth/ldap-change')[]} [changes] The set of changes to
   * apply.
   */
   ...
   *
   * @returns {import('@mbakereth/ldap-change')[]}
   */
  get changes () {
   ...
   *
   * @param {import('@mbakereth/ldap-change')[]} values
   *
