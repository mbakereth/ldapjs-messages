...
const Change = require('@mbakereth/ldapjs-change')
 ...
 * const {ModifyRequest} = require('@mbakereth/ldapjs-messages')
 * const Change = require('@mbakereth/ldapjs-change')
...
class ModifyRequest extends LdapMessage {
   ...
   * @property {import('@mbakereth/ldapjs-change')[]} [changes] The set of changes to
   * apply.
   */
   ...
   *
   * @returns {import('@mbakereth/ldapjs-change')[]}
   */
  get changes () {
   ...
   *
   * @param {import('@mbakereth/ldapjs-change')[]} values
   *
