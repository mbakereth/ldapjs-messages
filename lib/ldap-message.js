...
class LdapMessage {
   ...
   * @property {import('@mbakereth/ldapjs-controls').Control[]} [controls] A set of LDAP
   * controls to send with the message. See the `@mbakereth/ldapjs-controls` package.
   */
   ...
   *
   * @returns {import('@mbakereth/ldapjs-controls').Control[]}
   */
  get controls () {
   ...
   *
   * @param {import('@mbakereth/ldapjs-controls').Control[]} values
   *
   ...
   *
   * @returns {import('@mbakereth/ldapjs-asn1').BerReader}
   */
  toBer () {
   ...
   *
   * @param {import('@mbakereth/ldapjs-asn1').BerReader} ber A BER to parse. The reader
