...
class LdapMessage {
   ...
   * @property {import('@mbakereth/ldap-controls').Control[]} [controls] A set of LDAP
   * controls to send with the message. See the `@mbakereth/ldap-controls` package.
   */
   ...
   *
   * @returns {import('@mbakereth/ldap-controls').Control[]}
   */
  get controls () {
   ...
   *
   * @param {import('@mbakereth/ldap-controls').Control[]} values
   *
   ...
   *
   * @param {import('@mbakereth/ldap-asn1').BerReader} ber A BER to parse. The reader
